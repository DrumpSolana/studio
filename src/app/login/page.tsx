        ...
        <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-secondary/20 border-2 border-border p-8 rounded-lg shadow-lg">
                    <h1 className="text-3xl font-bold font-headline text-white mb-2 text-center">Customer Portal</h1>
                    <p className="text-white/80 mb-6 text-center">Sign in with your phone to see your points.</p>
