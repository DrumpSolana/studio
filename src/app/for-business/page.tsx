    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-secondary p-4">
      ...
      <Card className="w-full max-w-md bg-white border-black border-4 rounded-lg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-headline text-black">Business Sign Up</CardTitle>
          <CardDescription className="font-solway text-black/80">
            Create an account to get started with Drump for your business.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              />
              <Button type="submit" className="w-full bg-red-600 text-white font-bold border-2 border-black hover:bg-red-700 px-8 py-3 rounded-lg text-lg uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none transition-shadow">Sign Up</Button>
            </form>
          </Form>
        </CardContent>
      </Card>
