        ...
        <section className="relative flex items-center pt-32 pb-16 md:pt-40 md:pb-24 md:min-h-screen bg-transparent overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-32 z-10">
                <div className="grid md:grid-cols-7 gap-8 items-center">
                    <div className="space-y-8 text-center md:text-left md:col-span-4">
                    ...
                    <div className="relative h-auto md:col-span-3 w-full flex items-center justify-center mt-8 md:mt-0">
                         <Image
